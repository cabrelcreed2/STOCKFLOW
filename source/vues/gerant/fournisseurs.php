...
<head>
    ...
    <title>STOCKFLOW - Fournisseurs</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3><i class="fas fa-truck me-2" style="color: var(--primary);"></i>Gestion des fournisseurs</h3>
            <div class="d-flex align-items-center">
                <button class="btn btn-theme-toggle rounded-circle me-3" onclick="toggleTheme()" title="Basculer le thème">
                    <i id="theme-icon" class="fas fa-moon"></i>
                </button>
                <a href="fournisseur_ajouter.php" class="btn btn-outline-primary"><i class="fas fa-plus"></i> Ajouter</a>
            </div>
        </div>
                    ...
                    <tbody>
                        <?php foreach ($fournisseurs as $f): ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($f['est_actif']): ?><span class="badge bg-success">Actif</span>
                                    <?php else: ?><span class="badge bg-danger">Inactif</span><?php endif; ?>
                                    <?php if ($f['est_en_rupture']): ?><span class="badge bg-warning text-dark ms-1">En rupture</span><?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        <?php if (empty($fournisseurs)): ?>
                            <tr><td colspan="5" class="text-center py-4 text-muted">Aucun fournisseur.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
