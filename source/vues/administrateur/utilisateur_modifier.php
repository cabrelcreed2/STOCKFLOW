...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nom) || empty($prenom) || empty($email) || empty($role)) {
        ...
        $resultat = $adminCtrl->modifierUtilisateur($id, $nom, $prenom, $email, $role);
        
        if ($resultat === true) {
            // Changer le mot de passe si saisi
            if (!empty($nouveau_mdp)) {
                if (strlen($nouveau_mdp) >= 4) {
                    $utilisateurModel->modifierMotDePasse($id, $nouveau_mdp);
                } else {
...
<head>
    ...
    <title>STOCKFLOW - Modifier utilisateur</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-0"><i class="fas fa-user-edit me-2" style="color: var(--primary);"></i>Modifier utilisateur</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="password" name="nouveau_mdp" class="form-control" 
                               placeholder="Laisser vide pour ne pas changer" minlength="4">
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="role" class="form-select" required>
                            ...
                            <option value="CAISSIERE" <?php echo $utilisateur['role'] === 'CAISSIERE' ? 'selected' : ''; ?>>Caissière</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Statut</label>
                        <input type="text" class="form-control" 
                               value="<?php echo $utilisateur['est_actif'] ? 'Actif' : 'Inactif'; ?>" readonly>
                        <small class="text-muted">Gérable depuis la liste des utilisateurs.</small>
                    </div>
                </div>
                <hr>
